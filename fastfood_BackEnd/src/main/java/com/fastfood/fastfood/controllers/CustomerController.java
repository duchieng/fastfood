...
import com.fastfood.fastfood.services.CustomerService;
...
public class CustomerController {
	...
	*/
	...
	public ResponseEntity<Integer> placeANewOrder(@PathVariable String emailId,@PathVariable int branchId,@PathVariable int addressId)
			throws ResourceNotFoundException, OutOfLocationRangeException, OrderContainsInactiveItemsException
	{
