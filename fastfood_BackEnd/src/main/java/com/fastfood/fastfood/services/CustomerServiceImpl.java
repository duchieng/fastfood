...
//
	@Autowired
	public CustomerServiceImpl(EmailService javaMailSender) {
...
//			return dao.getAnUserDetails(emailId).getMyOrders();
	...
	@Override
	public int placeANewOrder(String emailId,int branchId,int addressId)
...
//
			javaMailSender.sendEmail(emailId);
