...
import com.fastfood.fastfood.exceptions.ChildRecordsFoundException;
...
public class AdminDaoImpl implements AdminDao {
	...
	public SubCategory getSubCategory(int subCategory) {
		return subCategoryRepository.getById(subCategory);
	...
	public void editCategory(String adminId, Category category) {
		User user = userRepository.findByEmailId(adminId) ;
